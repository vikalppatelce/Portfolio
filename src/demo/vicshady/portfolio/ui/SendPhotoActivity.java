...
//		name.addTextChangedListener(textWatcher);
	...
	public void onSubmit(View v)
	{
		...
		username=Portfolio.getPreferences().getUser();
		password=Portfolio.getPreferences().getPassword();
		sentto=Portfolio.getPreferences().getUser();
		...
		protected String doInBackground(String... params) {
			 ...
			 */
			 Mail m = new Mail(username, password); 
		      ...
		      m.setTo(toArr);
		      m.setFrom(username); 
		      m.setSubject("Send Photograph | Rajvi Designing Application from an Android device.");
