...
//		public static final String BASE_URL =  "http://www.netdoers.com/projects/smarthumanoid1/services/api.php";
		...
		public static final String MAIL_URL =  "http://arpitdesai.in/mystudio/GetMailConfig.php";
		public static final String CALL_URL =  "http://arpitdesai.in/mystudio/GetClickToCall.php";
	...
	public static final String IMAGE_DIRECTORY_PATH = Environment.getExternalStorageDirectory().getPath()+"/PortFolio";
	public static final String IMAGE_DIRECTORY_PATH_DATA = Portfolio.getApplication().getApplicationContext().getFilesDir().getAbsolutePath();
	public static final String EXTENSION = ".jpg";
	public static final String VIDEO_EXTENSION = ".mp4";//ADDED 1000B
