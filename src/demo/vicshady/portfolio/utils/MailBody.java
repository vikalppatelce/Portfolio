...
public class MailBody {
	...
	public static String getBody(String name,String contact,String address)
	{
		...
		str="<td style=\"padding:40px 20px;\" id=\"yui_3_13_0_ym1_1_1392534689432_2560\">\n" +
	            ...
	            "\t\t\t\t\t\t\t\t<br><br>\n" +
	            "\t\t\t\t\t\t\t\t<b>Welcome to <span style=\"color:#A7CA01;\">P</span>ortfolio</b><br>\n" +
	            "\t\t\t\t\t\t\t\t<b>and thank you for signing up on our Portfolio Android Platform!</b>\n" +
	            "\t\t\t\t\t\t\t</p>\n" +
	            ...
	            "\t\t\t\t\t\t\t\t<br><br><br>\n" +
	            "\t\t\t\t\t\t\t\t<b><i><span style=\"color:#A7CA01;\">(</span> <span style=\"color:#A7CA01;\">P</span>ortfolio Team <span style=\"color:#A7CA01;\">)</span></i></b>\n" +
	            "\t\t\t\t\t\t\t</p>\n" +
	            "\t\t\t\t\t\t</td>\n" +
	            "\t\t\t\t\t</tr>\n" +
	            "\t\t\t\t\t<tr>\n" +
