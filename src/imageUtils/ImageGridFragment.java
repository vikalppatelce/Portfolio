...
import imageUtils.ImageCache.ImageCacheParams;
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					Intent i = new Intent(Portfolio.getApplication().getApplicationContext(), ImageZoomActivity.class);
					i.putExtra("IMAGEURL", imgURL);
					startActivity(i);
//					overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_left);
//					Toast.makeText(Portfolio.getApplication().getApplicationContext(), imgURL, Toast.LENGTH_SHORT).show();
				}
			});
